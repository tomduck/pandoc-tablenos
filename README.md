...
This version of pandoc-tablenos was tested using pandoc 1.16.0.1 and 1.15.2, and should be compatible with earlier pandoc versions.  It is known to work under linux, Mac OS X and Windows.
